"""
given (lat and long) input is in degree. convert it to radian (d*(pi/180)) 
distance = math.sin(lat1)*math.sin(lat2)+math.cos(lat1)*math.cos(lat2)*math.cos(long2-long1)
"""
import math
import pandas as pd
